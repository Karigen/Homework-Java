...
public class Homework03_05 extends Application {
	...
	btn.layoutXProperty().bind(pane.widthProperty().divide(2).subtract(BTN_WIDTH/2));
	btn.layoutYProperty().bind(pane.heightProperty().divide(2).subtract(BTN_HEIGHT/2));
